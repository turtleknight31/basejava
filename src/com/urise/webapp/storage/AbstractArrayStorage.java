...
public abstract class AbstractArrayStorage implements Storage {
    ...
    protected abstract void findInsertionIndex(Resume resume, int index);

    protected abstract void findDeleteIndex(int index);
}
